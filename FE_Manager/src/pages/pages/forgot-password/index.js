  ...
  return (
    <>
      <Box className='content-center'>
        <Card sx={{ zIndex: 1, width: '32rem' }}>
          {isValidEmail ? (
            <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Image className='Logo' src='/images/logos/logo.png' alt='Logo' width={150} height={150} />
              </Box>
              <Box mb={4}>
                <Typography variant='h6'>Quên mật khẩu</Typography>
                <Box mb={4}>
                  <Typography variant='body2'>
                  Mật khẩu mới đã được gửi về email <strong>{email}</strong>, vui lòng kiểm tra hòm thư có chứa đường link để đổi mật khẩu, sau đó thực hiện việc đăng nhập lại.
                  </Typography>
                  <Box mt={2}>
                    {count === 0 ? (
            ...
            <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
              ...
              <Box sx={{ mb: 3 }}>
                <Box mb={4}>
                  <Typography variant='h6'>Quên mật khẩu</Typography>
                  <Typography variant='body2'>Vui lòng nhập email của bạn để khôi phục lại mật khẩu</Typography>
                  <Typography variant='body2' color='error'>
                    Nếu không có email, vui lòng liên hệ với quản lý để lấy lại mật khẩu
                  </Typography>
                </Box>
                <TextField
                  mt={3}
